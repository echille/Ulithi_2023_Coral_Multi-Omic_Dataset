...
#SBATCH --job-name=RH_raw_bam_qc
#SBATCH --output=/scratch/eec72/Ulithi23/03_STDOUT/RH_raw_bam_qc.%A.%a.out
#SBATCH --array=1-83
...
COMMANDS_FILE="02_scripts/03_raw_bam_qc_array_commands.txt"
